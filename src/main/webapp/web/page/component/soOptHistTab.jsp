					...
					<tr>
						...
						<td>
							<c:choose>
								...
								<c:when test="${optHist.operateType == 2||optHist.operateType==4||optHist.operateType==8||optHist.operateType==10}">
									修改
								</c:when>
						...
						<script type="text/javascript">
							function showPoHist(histID){
								parent.addTab('tabId_viewSo', '销售订单历史详情', 'saleManage/viewHist/'+ histID);
							}
						</script>
						<c:if test="${optHist.operateType==4||optHist.operateType==10}">
